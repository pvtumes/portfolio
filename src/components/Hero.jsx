    ...
    <section id="home" className="hero" aria-label="Introduction">
      ...
      <div className="container hero__inner">
        ...
        <div className="hero__content">
          ...
          <h1 className="hero__name fade-up-init" style={{ animationDelay: '0.1s' }}>
            Hi, I'm <span className="hero__name-highlight">{personal.name}</span>
          </h1>

          <p className="hero__role fade-up-init" style={{ animationDelay: '0.18s' }}>
            {personal.role}
          </p>

          <p className="hero__tagline fade-up-init" style={{ animationDelay: '0.26s' }}>
            {personal.tagline}
          </p>

          <div className="hero__actions fade-up-init" style={{ animationDelay: '0.34s' }}>
            <button
          ...
          {/* Social links */}
          <div className="hero__socials fade-up-init" style={{ animationDelay: '0.42s' }}>
            <a href={personal.github} target="_blank" rel="noopener noreferrer" className="hero__social-link" aria-label="GitHub">
            ...
            <a href={personal.linkedin} target="_blank" rel="noopener noreferrer" className="hero__social-link" aria-label="LinkedIn">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            ...
            {personal.leetcode && (
              <a href={personal.leetcode} target="_blank" rel="noopener noreferrer" className="hero__social-link" aria-label="LeetCode">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        ...
        {/* Right: Profile */}
        <div className="hero__image-wrap fade-up-init" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="hero__image-badge hero__image-badge--1" aria-hidden="true">
            <span>☕</span> Java
          </div>
      ...
      {/* Scroll indicator */}
      <div className="hero__scroll-indicator fade-up-init" style={{ animationDelay: '0.7s' }} aria-hidden="true">
